    ...
    return (
      <div className="flex-1 flex flex-col items-center justify-center bg-white dark:bg-slate-950 transition-colors duration-300 px-6">
        <div className="text-center">
          ...
          <button
            onClick={onAbort}
            className="px-5 py-2.5 bg-slate-100 dark:bg-slate-800 hover:bg-red-50 dark:hover:bg-red-900/30 text-slate-600 dark:text-slate-300 hover:text-red-600 dark:hover:text-red-400 rounded-xl transition-colors text-sm font-medium"
          >
            생성 중단
          </button>
        </div>
